  ...
  const personas = [
    {
      key: "admin",
      badge: "👑 Full Access",
      name: "Carol Danvers (Admin Lead)",
      email: "admin@bugforge.demo",
      role: "admin",
      scope: "Workspace deletion, accent customization, user roles",
    },
    {
      key: "triage",
      badge: "🎯 Triage & AI",
    ...
    },
    {
      key: "developer",
      badge: "💻 Core Dev",
      name: "Alice Smith (Core Engineer)",
      email: "dev@bugforge.demo",
      role: "member",
      scope: "Edit issue reproduction, comments, evidence, link issues",
    },
    {
      key: "viewer",
      badge: "👁️ Read-Only",
      name: "Bob Jones (Reporter / QA)",
      email: "viewer@bugforge.demo",
      role: "viewer",
      scope: "Read-only access: tests server rejection on mutations",
    },
  ];
