...
See [`docs/submission-ready-brief.md`](docs/submission-ready-brief.md) for a concise evaluation-oriented summary, [`docs/architecture.md`](docs/architecture.md) for system design, and [`docs/demo-script.md`](docs/demo-script.md) for a suggested walkthrough.
