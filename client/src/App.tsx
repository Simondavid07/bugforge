...
export default function App() { return <ErrorBoundary><ThemeProvider defaultTheme="light" switchable><TooltipProvider><Toaster richColors /><Router /><CommandPalette /><ProjectPersonalization /><div id="personalization-announcer" className="sr-only" aria-live="polite" aria-atomic="true" /></TooltipProvider></ThemeProvider></ErrorBoundary>; }
